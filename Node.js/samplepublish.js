...
// This is a demonstration showing the publish operations onto a MQ Topic
...
var debug_info = require('debug')('samplepub:info');
var debug_warn = require('debug')('samplepub:warn');
...
mqBoilerPlate.initialise('PUBLISH')
  .then(() => {
