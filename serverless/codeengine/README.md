...
## The Application
The application can be found in the folder `clientapp`. The application structure is designed to run as a Code Engine buildpack app, but can be run locally.  
